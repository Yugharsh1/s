...
lbl_dr = Label(root, text = "Doctor : ", font = ("Brush Script MT", 15, "bold"), bg = "blue", fg = "white")
lbl_dr.place(relx = 0.1, rely = 0.3, anchor = CENTER)

lbl_it = Label(root, text = "IT Professtional : ", font = ("Brush Script MT", 15, "bold"), bg = "blue", fg = "white")
lbl_it.place(relx = 0.1, rely = 0.6, anchor = CENTER)


lbl_chemical = Label(root, text = "Chemical Engineer : ", font = ("Brush Script MT", 15, "bold"), bg = "blue", fg = "white")
...
lbl_selected_dr = Label(root, font = ("times", 12, "bold"), bg = "blue", fg = "white")
lbl_selected_dr.place(relx = 0.3, rely = 0.3, anchor = CENTER)


lbl_selected_it = Label(root, font = ("times", 12, "bold"), bg = "blue", fg = "white")
lbl_selected_it.place(relx = 0.3, rely = 0.6, anchor = CENTER)


lbl_selected_chemical = Label(root, font = ("times", 12, "bold"), bg = "blue", fg = "white")
...
btn_dr = Button(root, text = "Show the Hospital Alloted", command = child1_obj.get_dr, bg = "blue", relief = FLAT, fg = "white")
btn_dr.place(relx = 0.1, rely = 0.2, anchor = CENTER)

btn_it = Button(root, text = "Show the IT Company Alloted", command = child2_obj.get_it, bg = "blue", relief = FLAT, fg = "white")
btn_it.place(relx = 0.1, rely = 0.5, anchor = CENTER)

btn_chemical = Button(root, text = "Show the Chemical Company Alloted", command = child3_obj.get_chemical, bg = "blue", relief = FLAT, fg = "white")
